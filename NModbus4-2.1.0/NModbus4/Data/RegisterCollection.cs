namespace Modbus.Data
{
    ...
    public class RegisterCollection : Collection<ushort>, IModbusMessageDataCollection
    {
        ...
        //TODO phl temporaire: pour contenir les bytes directement
        //dans la conversion il pad avec des 0 alors ça fausse le checksum
        public RegisterCollection(byte[] bytes, bool byteOnly)
            : this((IList<ushort>)byteArrayToUShortArray(bytes))
        {
        }
        ...
        //TODO phl
        private static ushort[] byteArrayToUShortArray(byte[] bytes)
        {
