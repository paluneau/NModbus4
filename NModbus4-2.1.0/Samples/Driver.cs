    ...
    public class Driver
    {
        private static void Main(string[] args)
        {
            ...
            do
            {
                ...
                keyTyped = Console.ReadKey().KeyChar;
                Console.WriteLine();
            
            } while (keyTyped != ('q') && keyTyped != ('Q'));

        }

        //TODO méthode de vérif
        public static void ModbusSerialRtuReportSlaveId()
        {
            using (SerialPort port = new SerialPort())
            {
                //Settings du port série
                ...
                //Création du master modbus
                var master = ModbusSerialMaster.CreateRtu(port);

                //Envoi de la commande ReportSlaveId(17) au slave
                byte slaveAddress = 1;
                byte[] data = master.ReportSlaveId(slaveAddress);
